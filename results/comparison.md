...
Numeros = media do ledger experiments.json (6 seeds/algo) via experiment compare.
Seeds 4-6 coletadas com boot fresco (reflash + hard-reset) — ver gotcha: contadores
