...
processadas, pares de comunicação e endereços MAC. A Figura~\ref{fig:estrutura-modular} apresenta
...
\caption{Estrutura modular da implementação do AODV-EN}\label{fig:estrutura-modular}
\end{figure}
...
Quadro~\ref{quad:estruturas-dados} apresenta uma síntese das principais estruturas utilizadas na
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{Estruturas de dados utilizadas no AODV-EN}\label{quad:estruturas-dados}\\
\toprule\noalign{}
...
O Quadro~\ref{quad:mensagens} apresenta uma síntese das mensagens utilizadas pelo AODV-EN
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{Mensagens utilizadas pelo AODV-EN}\label{quad:mensagens}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Mensagem
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
dispositivos ESP32 utilizando ESP-NOW. O Quadro~\ref{quad:adaptacoes} sintetiza as
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{Principais adaptações do AODV para o contexto do ESP-NOW}\label{quad:adaptacoes}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Aspecto
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
