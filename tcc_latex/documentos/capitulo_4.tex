...
\caption{Arquitetura geral do AODV-EN}
\end{figure}
...
processadas, pares de comunicação e endereços MAC. A Figura 4 apresenta
...
\caption{Estrutura modular da implementação do AODV-EN}
\end{figure}
...
\end{tikzpicture}
\caption{Fluxo de descoberta de rotas no AODV-EN}
\end{figure}
...
\draw[arr] (res)--(end);
\end{tikzpicture}
\caption{Fluxo de tratamento de falhas e reconvergência no AODV-EN}
\end{figure}
