...
Energia (J, estimada) & 39,4 $\pm$ 0,6 & 28,4 $\pm$ 0,03 \\
\bottomrule
\end{tabular}
...
Ao longo de 30 repetições, a taxa de entrega caiu para 62,8\%
($\mathrm{IC95} = \pm 11{,}5$), contra 94,1\% do mesmo protocolo sem falha
(C1), e a latência subiu para 60,7~ms ($\mathrm{IC95} = \pm 14{,}6$),
refletindo o tempo de detecção da quebra e de re-descoberta de rota. A
elevada variabilidade entre repetições (coeficiente de variação de cerca de
51\%) decorre da natureza estocástica do instante da falha em relação ao
tráfego: repetições em que a janela de queda coincide com poucos envios
preservam entrega alta, enquanto outras concentram as perdas no intervalo de
recuperação. A Figura~\ref{fig:c4-selfheal} ilustra o fenômeno em uma
repetição: a curva de pacotes entregues acumulados exibe \emph{patamares}
--- intervalos sem entrega que coincidem com a indisponibilidade do relé ---
seguidos de \emph{retomada}, evidência direta da auto-recuperação
(\emph{self-healing}) pela rota alternativa.
...
a campanha em hardware cobre os cenários C1 (cadeia multi-hop de dez nós,
três a quatro saltos) e C4 (falha induzida, seis nós), ambos com trinta
repetições por algoritmo, e a avaliação quantitativa do \emph{flooding} sob
falha (C4) e os cenários C2 e C3 (árvore e malha redundante), embora
viabilizados pela mesma infraestrutura de coleta, ficam como trabalho
...
agregado desse algoritmo. A medição física de energia, a execução dos
cenários C2 e C3 e a avaliação do \emph{flooding} sob falha constituem
