...
contra 74\% --- mostra que o AODV-EN não apenas entrega mais, mas o faz de
...
Energia por pacote entregue (J) & 0,70 $\pm$ 0,02 & 0,81 \\
\bottomrule
\end{tabular}

\vspace{2pt}
{\footnotesize Fonte: Elaborado pelos autores. \emph{Recepções por entrega} = recepções
agregadas na rede por pacote efetivamente entregue, indicador de ocupação de canal;
\emph{energia por pacote entregue} = razão entre energia total da rede e total de pacotes
entregues. Todas as diferenças são significativas (teste $t$ de Welch, $p<0{,}001$).}
\end{table}
...
com 26 das 30 repetições acima de 85\%. O \emph{flooding} apresentou maior
dispersão (48,3\% a 95,0\%; mediana 78,7\%; CV de 13,0\%), refletindo a
