...
multi-hop (três a quatro saltos) e trinta repetições por algoritmo; os
cenários C2 a C4 constituem extensão direta sobre a mesma infraestrutura
de coleta, com avaliação complementar de escala por simulação
