...
Quanto à natureza, esta pesquisa é aplicada, pois desenvolve uma solução prática para um problema concreto: a ausência de roteamento multi-hop nativo no ESP-NOW \cite{gil2017}. Quanto aos procedimentos, é experimental, pois implementa um protótipo funcional (o AODV-EN) e o submete a testes controlados, manipulando variáveis independentes (topologia, número de nós e padrões de tráfego) e medindo seus efeitos sobre variáveis dependentes (taxa de entrega, latência, carga de controle e consumo energético). Quanto à abordagem, é quantitativa: as métricas --- PDR, latência fim-a-fim, NRL e consumo energético --- são obtidas por medição sistemática e tratadas estatisticamente.
...
e (6) comunicação. O Quadro~\ref{quad:etapas-dsr} apresenta estas etapas e suas descrições.

{\def\LTcaptype{quadro}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5000}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5000}}@{}}
\caption{Etapas do Design Science Research segundo \citeauthor{peffers2007} (\citeyear{peffers2007})}\label{quad:etapas-dsr}\\
\toprule\noalign{}
...
Quadro~\ref{quad:mapeamento-fases} apresenta este mapeamento, relacionando cada fase do trabalho à
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{Mapeamento das fases do trabalho às etapas da DSR}\label{quad:mapeamento-fases}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Fase
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
(Capítulo~\ref{resultados-e-discussuxe3o}, Seção~\ref{anuxe1lise-de-escalabilidade-por-simulauxe7uxe3o}). O Quadro~\ref{quad:cenarios} detalha a configuração de cada cenário experimental.
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{Configuração dos cenários experimentais}\label{quad:cenarios}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Cenário
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{Parâmetros dos experimentos}\label{quad:parametros}\\
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{Métricas de avaliação de desempenho}\label{quad:metricas}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Métrica
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
